  ...
  <div class="container">
    ...
    <div class="section">
      ...
      <div class="row">
        ...
        $readBook = "SELECT * FROM buku_pengarang BP JOIN buku B ON B.id_buku = BP.id_buku JOIN kategori K ON K.id_kategori = B.id_kategori JOIN pengarang P ON P.id_pengarang = BP.id_pengarang";
          ...
          <div class="col s12 m3">
            <div class="card">
              ...
              <div class="card-content">
                <center><h6><a href="viewbook.php?id=<?php echo $rowBook['id_buku']; ?>" class="orange-text"><b><?php echo $rowBook['judul_buku']; ?></b></a></h6></center>
              </div>
            </div>
          </div>
